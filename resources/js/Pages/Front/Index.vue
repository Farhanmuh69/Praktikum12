    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">{{ judul.judul }}</span>
            </a>
    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                <h2 class="font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl"> {{ nama.judul }}
                </h2>
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://www.instagram.com/farhanmuh_/"
            ...
            <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                <div className="sm:col-span-12 lg:col-span-3">
                    ...
                    <div className="text-sm text-gray-600">
                        <img src="../../Components/images/logo.png" class="h-8 mr-3" alt=" Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Han</span>
                    </div>
                </div>
